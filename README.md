<p align="center">
  ...
  <p align="center">
    <a href="https://github.com/gafaraleshe/Sigma/actions"><img src="https://github.com/gafaraleshe/Sigma/actions/workflows/ci.yml/badge.svg" alt="CI/CD"></a>
...
We're evolving Sigma from an app into a **shippable, multi-tenant invoicing SaaS**
...
| [`docs/Sigma-Product-Guide.pdf`](docs/Sigma-Product-Guide.pdf) | One-page-per-topic PDF for you **and your clients** — summary, setup, costs, timeline |
...
git clone https://github.com/gafaraleshe/Sigma.git
cd Sigma
...
| `RESEND_FROM_EMAIL` | No | Sender email address (defaults to `Sigma <invoices@resend.dev>`) |
...
Sigma computes UK VAT automatically on every invoice. The calculation follows this formula:
