...
const allFeatures = [
  ...
  },
  {
    ...
    body: "Set it once and let HermiteFlow issue and send invoices on whatever cadence you need.",
  },
  {
    icon: Globe,
...
const crmPoints = [
  ...
  "Map HermiteFlow fields to your CRM's custom objects",
...
const spotlights = [
  ...
  },
  {
    ...
    body: "Configure a reminder schedule once and HermiteFlow runs the follow-ups for you — flipping invoices to paid the instant the money arrives.",
    points: [
        ...
        <Container>
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-5 text-[17px] leading-relaxed text-[var(--mkt-ink-subtle)]">
                On Enterprise, HermiteFlow syncs both ways with the CRM your
